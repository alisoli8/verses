  ...
  return (
    <div className="relative flex flex-col items-center justify-between min-h-screen w-full bg-gray-900 text-white p-8">
      ...
      <div className="z-10 text-center mt-24">
        <VsIcon className="w-24 h-24 text-brand-lime mx-auto" />
        <h1 className="text-5xl font-extrabold mt-4 tracking-tight">AI VS Arena</h1>
        <p className="mt-4 text-lg text-gray-300 max-w-md mx-auto">
          Create epic battles. Let the world decide the winner.
        </p>
      </div>
      ...
      <div className="z-10 w-full max-w-sm mb-8">
        <button
          ...
          className="w-full bg-brand-lime text-gray-900 font-bold py-4 rounded-xl text-lg transition-transform transform hover:scale-105"
        >
          Get Started
        </button>
        <button
          onClick={onGoToLogin}
          className="w-full mt-4 text-brand-lime font-bold py-4 rounded-xl text-lg hover:bg-white/10 transition-colors"
        >
          Log In
        </button>
      </div>
